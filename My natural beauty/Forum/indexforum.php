...
<body>
	<div class="logo">
					<a href="indexforum.php"><img src="../images/logo.png" width="250px" height="100px" title="naturex" /></a>
				</div>
		<!---start-wrap---->
		<div class="wrap">
			<!---start-header---->
...
$rowquery=mysql_fetch_array(mysql_query("select count(*) from categories"));
$rowcount=$rowquery[0];

$requetep="select * from categories LIMIT ".$count." OFFSET ".($page*$count);


$resultat1 =mysql_query($requetep) or die(mysql_error());
...
<div class="pagination">
 <?php 
 if($page>0) echo "<a href=\"indexforum.php?page=".($page-1)."\"><img src=../images/left.png width=16px /></a> |";
 
 for($i=0;$i<$rowcount;$i+=$count){
	if($page==$i/$count) echo "<b>";
	echo "<a href=\"indexforum.php?page=".($i/$count)."\"> ".(($i/$count)+1)." </a> |";
	
 }


  if($page<($rowcount/$count)-1) echo "<a href=\"indexforum.php?page=".($page+1)."\"><img src=images/right.png width=16px /></a>"; 
