...
<input type="text" width="20px" name="rech" value="" placeholder="saisir le pseudo" />
</form>
</li>
...
<tr>
	<th>Id  personne</th><th>Nom</th><th>Prénom</th><th>Pseudo</th><th>Email</th><th>Sexe</th><th>Pays</th><th>Age</th><th>Password</th><th>Supprimer</th>
</tr>
...
<tr>
	...
	<td> <a href="suppression.php?id=<?php  echo $data['id']; ?>"> <h3><img src="images/supprimer.png" width="32px"></h3> </a>
    </tr>
  <?php } // fermeture de la boucle while?>
</table>
<div class="pagination">
<?php 
 if($page>0) echo "<a href=\"suppriuser.php?page=".($page-1)."\"><img src=images/left.png width=16px /></a> |";
 
 for($i=0;$i<$rowcount;$i+=$count){
	if($page==$i/$count) echo "<b>";
	echo "<a href=\"suppriuser.php?page=".($i/$count)."\"> ".(($i/$count)+1)." </a> |";
	if($page==$i/$count) echo "</b>";
 }


  if($page<($rowcount/$count)-1) echo "<a href=\"suppriuser.php?page=".($page+1)."\"><img src=images/right.png width=16px /></a>"; 
