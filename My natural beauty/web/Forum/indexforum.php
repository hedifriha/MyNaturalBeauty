...
<div class="box">
	...
	<div class="box_right">
    	<a href="list_pm.php">Vos messages(<?php /*echo $nb_new_pm; */?>)</a> - <a href="profile.php?id=<?php echo $_SESSION['l']; ?>"><?php echo htmlentities($_SESSION['l'], ENT_QUOTES, 'UTF-8'); ?></a> (<a href="login.php">Déconnexion</a>)
    </div>
	<div class="clean"></div>
</div>
<?php
...
<div class="box">
	...
	<div class="box_right">
    	<a href="signup.php">Inscription</a> - <a href="../login.html">Connexion</a>
    </div>
	<div class="clean"></div>
</div>
<?php
}
if(isset($_SESSION['l']) and $_SESSION['l']=="admin")
{
?>
